        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-600 mb-4 max-w-md">
              The professional networking and job platform that connects talent with opportunity through AI-powered matching and Web3 innovation.
            </p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm">
              © 2024 RizeOS. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0 flex space-x-6">
              <span className="text-gray-400 text-sm">Built with ❤️ for RizeOS Internship</span>
            </div>
          </div>
        </div>
      </div>
